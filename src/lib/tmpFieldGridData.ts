...
export const studentFieldData = fieldMap<StudentData>(
  studentData,
...
export const studentGridData = gridMap(
  rowGrid.label("기본정보").one(studentFieldData.name),
  rowGrid.two(studentFieldData.gender, studentFieldData.birth),
  rowGrid.two(studentFieldData.gender, studentFieldData.birth, [1, 2]),
  rowGrid.two(
    get(studentFieldData.license_list, 0),
    get(studentFieldData.license_list, 2)
  )
);
